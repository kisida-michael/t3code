...
export const ProviderModelPicker = memo(function ProviderModelPicker(props: {
  ...
  providerOptions?: ReadonlyArray<ProviderKind>;
  ...
  const allowedProviders = props.providerOptions;
  const visibleProviderOptions =
    allowedProviders === undefined
      ? AVAILABLE_PROVIDER_OPTIONS
      : AVAILABLE_PROVIDER_OPTIONS.filter((option) => allowedProviders.includes(option.value));
